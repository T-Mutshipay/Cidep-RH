...
<body class="bg-gray-100 text-gray-900">
    <div class="max-w-2xl mx-auto p-6 bg-white shadow-md rounded-lg mt-10">
        ...
        <p class="mb-2"><strong>Nouvelle Direction :</strong> <span class="text-blue-600">{{ $newDirection }}</span></p>
        <p class="mb-4"><strong>Date de Mutation :</strong> <span class="text-blue-600">{{ $dateMutation }}</span></p>
